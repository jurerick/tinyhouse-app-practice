...
const loginViaGoogle = (code, token, db, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const userEmailsList = user.emailAddresses && user.emailAddresses.length
        ? user.emailAddresses
        : null;
    const userName = userNameList && userNameList[0].displayName
        ? userNameList[0].displayName
        : null;
    const userId = userNameList && userNameList[0].metadata && userNameList[0].metadata.source
        ? (_a = userNameList[0].metadata.source) === null || _a === void 0 ? void 0 : _a.id
        : null;
    ...
    Mutation: {
        ...
        connectStripe: (_root, { input }, { db, req }) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                ...
                const wallet = api_1.Stripe.connect(code);
                if (!wallet) {
                    throw new Error("stripe grant error");
                }
                const updateRes = yield db.users.findOneAndUpdate({ _id: viewer._id }, { $set: { walletId: (yield wallet).stripe_user_id } }, { returnDocument: "after" });
                if (!updateRes.value) {
